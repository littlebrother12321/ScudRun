...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionUDP_Target = new QAction(MainWindow);
        actionUDP_Target->setObjectName(QString::fromUtf8("actionUDP_Target"));
        ...
        menuSet->addAction(actionUDP_Target);
